...
const handleStake = () => {
      ...
      <div className="flex flex-col items-center justify-center text-center">
        <div className="mb-6">
          <div className="inline-flex items-center justify-center">
            <img src="/images/serebro.png" alt="logo"/>
          </div>
        </div>
        <h1 className="text-4xl font-bold mb-10">{creatorName}</h1>
          ...
          <>
            ...
            <div className="flex flex-row items-center">
              <input
                ...
                className="bg-gray-800 text-white font-bold py-2 px-4 rounded mr-4 mt-4"
                min="0.0001"
              />
              <button
                onClick={handleStake}
  ...
  {items.map((item, index) => (
    <div key={index} className="bg-gray-800 p-4 rounded-lg shadow-lg w-100 flex flex-row items-center justify-between">
      ...
      >
        ...
        <img className="mt-20" src="/images/stakes_logo.png" alt="logo"/>
      </div>
    </div>
  );
}
